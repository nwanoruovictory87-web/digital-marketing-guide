      ...
      <div className="rounded-md max-w-200 flex flex-col">
        ...
        <span className="flex justify-center mt-3 text-center">
          <h5 className="text-[1.1rem] text-gray-100">
            ...
            <strong>Digital/Affiliate Marketer</strong>. By now, you understand
            the basics of digital marketing, but what you've learned so far is
            only scratching the surface of what digital marketing truly
            involves.
            <br />
            <br />
            To help you go further, I've put together a comprehensive PDF course
            that teaches you how to get started in digital marketing and begin
            earning online. This is a <strong>step-by-step guide</strong>{" "}
            designed for both beginners and aspiring marketers, covering
        ...
        <span className="flex justify-center mt-3 text-center">
          <div>
            <h5 className="text-[1.1rem] text-gray-100">
              ...
              you'll get everything you need to start your Digital Marketing and
              Affiliate Marketing journey with confidence.
            </h5>
            <ul className="text-gray-100 text-[1.1rem] space-y-3 mt-4 list-disc pl-6">
              <li>
                <strong>Complete Beginner-to-Advanced PDF Guide</strong> – Learn
                Digital Marketing and Affiliate Marketing from the ground up.
              </li>
              ...
              <li>
                <strong>Access to an Affiliate Program</strong> – Get access to
                an affiliate network where you can promote digital products and
                earn commissions.
              </li>
              ...
              <li>
                <strong>Product Selection Guide</strong> – Learn how to identify
                products with strong earning potential.
              </li>

              <li>
                <strong>Traffic Generation Strategies</strong> – Discover how to
                attract potential buyers using free and paid methods.
              </li>

              <li>
                <strong>Social Media Marketing Training</strong> – Learn how to
                market products on platforms like Facebook, Instagram, TikTok,
                WhatsApp, and more.
              </li>
              ...
              <li>
                <strong>Beginner-Friendly Lessons</strong> – No prior experience
                or special skills required.
              </li>

              <li>
                <strong>Lifetime Access to the PDF</strong> – Revisit the guide
