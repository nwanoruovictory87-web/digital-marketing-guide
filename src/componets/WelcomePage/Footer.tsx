function Footer() {
  return (
    <div className="flex justify-center">
      <div className="w-full pl-5 pr-5 mt-8 flex flex-col sm:gap-4 gap-2 mb-7 max-w-200">
        <div className="flex flex-wrap gap-3">
          <span className="flex flex-col gap-2  text-gray-200  text-[0.9rem] min-[400px]:text-[1.1rem] sm:text-[1.2rem]">
            <h5>Privacy Policy</h5>
          </span>
          <span className="flex flex-col gap-2  text-gray-200  text-[0.9rem] min-[400px]:text-[1.1rem] sm:text-[1.2rem]">
            <h5>Terms of Service</h5>
          </span>
          <span className="flex items-center gap-1  text-gray-200  text-[0.9rem] min-[400px]:text-[1.1rem] sm:text-[1.2rem]">
            <span className="">
              <a
                className=""
        ...
        <div className="flex justify-center mt-4">
          <span className="flex flex-col gap-2 mt-2 text-gray-200  text-[0.7rem] sm:text-[1.2rem]">
            <h5>
              © 2026 Digital Marketing Guide. ALL rights reserved. Builts by
              Victory
            </h5>
          </span>
        </div>
